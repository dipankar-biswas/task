                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('brand.update',$brands->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group imageChange">
                                ...
                                <img class="imagePreview mt-3 border rounded" src="{{ !empty($brands->image) ? asset($brands->image) : asset('assets/images/dummy-image.jpg') }}" alt="Image" style="width:100px;height: 100px;object-fit:contain;">
                            </div>
